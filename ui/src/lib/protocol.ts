...
export type ClientMessage =
  ...
  | { type: "shell_attach"; worktree_id: string; shell_id?: string; cols: number; rows: number }
  | { type: "shell_input"; worktree_id: string; shell_id?: string; data: string }
  | { type: "shell_resize"; worktree_id: string; shell_id?: string; cols: number; rows: number }
  | { type: "shell_kill"; worktree_id: string; shell_id?: string }
  // Transfer
